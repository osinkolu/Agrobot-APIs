...
# Reset everything to conform based on the model selected.
    ...
    def set_params(self):
        ...
        if self.name == "cropdisease":
            ...
            self.demo1 = "tempDir/cropdisease_test_01.jpg"
            self.demo2 = "tempDir/cropdisease_test_02.jpg"
            self.demo3 = "tempDir/cropdisease_test_03.jpg"
            self.string1 = "what is "
            self.string2 = "Latest on curing "
            self.string3 = "how to cure "

            #If the fruits harvest model is selected
        elif self.name == "fruitsharvest":
